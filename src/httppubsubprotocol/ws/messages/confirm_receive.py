...
from httppubsubprotocol.sync_io import SyncReadableBytesIOA
...
if TYPE_CHECKING:
    __: Type[S2B_MessageParser[S2B_ConfirmReceive]] = S2B_ConfirmRecieveParser
